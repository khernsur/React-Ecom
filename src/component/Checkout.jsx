                        ...
                        <form className="needs-validation" novalidate="">
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="firstName" placeholder="Khern" value="" required="" />
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="lastName" placeholder="Sur" value="" required="" />
                                    <div className="invalid-feedback">
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="text" className="form-control" id="address" placeholder="BGC Taguig" required="" />
                                    <div className="invalid-feedback">
